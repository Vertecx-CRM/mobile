...
class AppointmentPageTecnico extends StatefulWidget {
  const AppointmentPageTecnico({super.key});

  @override
  State<AppointmentPageTecnico> createState() => _AppointmentPageTecnicoState();
}

class _AppointmentPageTecnicoState extends State<AppointmentPageTecnico> {
        ...
        child: BlocBuilder<CalendarBloc, CalendarState>(
          builder: (context, state) {
            final fallbackMap = state is CalendarLoaded
                ...
                ? state.appointmentsByDay
                : {};
            final eventsByDay = _eventsByDayCache.isNotEmpty
                ? _eventsByDayCache
                : fallbackMap;
              ...
              if (filtered.isEmpty) {
                ...
                appointmentsSection = ListView.builder(
                  ...
                  itemBuilder: (context, index) =>
                      AppointmentCard(cita: filtered[index], esTecnico: true),
                );
              }
            }
                      ...
                      TableCalendar(
                        ...
                        calendarBuilders: CalendarBuilders(
                          defaultBuilder: (context, day, focusedDay) {
                            final hasAppointment = eventsByDay.keys.any(
