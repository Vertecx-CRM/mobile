...
class AppointmentPageTecnico extends StatefulWidget {
  ...
  @override
  State<AppointmentPageTecnico> createState() => _CalendarPageTecnicoState();
}

class _CalendarPageTecnicoState extends State<AppointmentPageTecnico> {
                ...
                if (state is CalendarLoading) {
                  ...
                  return ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      return AppointmentCard(cita: citas[index], esTecnico: true);
